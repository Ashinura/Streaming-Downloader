...
def sc_config_menu_song():
    ...
    rich.print( "┌-----------------------------------------------------------------------------------------------------------┐")
    rich.print( "|                                           SoundCloud - Song                                                 |")
    rich.print( "├-----------------------------------------------------------------------------------------------------------┤\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]1[/bold white]" + "[yellow]][/yellow]", f"Edit - Path & Format\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]2[/bold white]" + "[yellow]][/yellow]", f"Edit - Path: [green]{sc_song_path}[/green]")
    rich.print("    [yellow][[/yellow]" + "[bold white]3[/bold white]" + "[yellow]][/yellow]", f"Edit - Format : [green]{sc_song_format}[/green]")
    rich.print("\n└----------------------------------------------------------------------------------------------------------┘\n")
    ...
    if option == 0: 
        ...
        sc_config_menu_song_editpath(andformat=True)

    elif option == 2:
        sc_config_menu_song_editpath(andformat=False)

    elif option == 3:
        sc_config_menu_song_editformat()
...
def sc_config_menu_song_editpath(andformat):
...
def sc_config_menu_song_editformat():
    ...
    elif (new_format == sc_song_format):
