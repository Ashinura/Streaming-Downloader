...
def sc_config_menu():
    ...
    rich.print("    [yellow][[/yellow]" + "[bold white]3[/bold white]" + "[yellow]][/yellow]", f"Edit - Playlist | Path: [green]{sc_playlist_path}[/green] - Format : [green]{sc_playlist_format}[/green]")
