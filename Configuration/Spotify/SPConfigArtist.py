...
def sp_config_menu_artist():
    ...
    rich.print( "┌-----------------------------------------------------------------------------------------------------------┐")
    rich.print( "|                                           Spotify - Artist                                                 |")
    rich.print( "├-----------------------------------------------------------------------------------------------------------┤\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]1[/bold white]" + "[yellow]][/yellow]", f"Edit - Path & Format\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]2[/bold white]" + "[yellow]][/yellow]", f"Edit - Path: [green]{sp_artist_path}[/green]")
    rich.print("    [yellow][[/yellow]" + "[bold white]3[/bold white]" + "[yellow]][/yellow]", f"Edit - Format : [green]{sp_artist_format}[/green]")
    rich.print("\n└----------------------------------------------------------------------------------------------------------┘\n")
    ...
    if option == 0: 
        ...
        sp_config_menu_artist_editpath(andformat=True)

    elif option == 2:
        sp_config_menu_artist_editpath(andformat=False)

    elif option == 3:
        sp_config_menu_artist_editformat()
...
def sp_config_menu_artist_editpath(andformat):
...
def sp_config_menu_artist_editformat():
    ...
    elif (new_format == sp_artist_format):
