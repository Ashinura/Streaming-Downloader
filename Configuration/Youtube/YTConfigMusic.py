...
def yt_config_menu_music():
    ...
    rich.print( "┌-----------------------------------------------------------------------------------------------------------┐")
    rich.print( "|                                           YouTube - Music                                                 |")
    rich.print( "├-----------------------------------------------------------------------------------------------------------┤\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]1[/bold white]" + "[yellow]][/yellow]", f"Edit - Path & Format\n")
    rich.print("    [yellow][[/yellow]" + "[bold white]2[/bold white]" + "[yellow]][/yellow]", f"Edit - Path: [green]{yt_musics_path}[/green]")
    rich.print("    [yellow][[/yellow]" + "[bold white]3[/bold white]" + "[yellow]][/yellow]", f"Edit - Format : [green]{yt_musics_format}[/green]")
    rich.print("\n└----------------------------------------------------------------------------------------------------------┘\n")
    ...
    if option == 0: 
        ...
        yt_config_menu_music_editpath(andformat=True)

    elif option == 2:
        yt_config_menu_music_editpath(andformat=False)

    elif option == 3:
        yt_config_menu_music_editformat()
...
def yt_config_menu_music_editpath(andformat):
...
def yt_config_menu_music_editformat():
